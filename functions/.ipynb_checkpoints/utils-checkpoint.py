...
def render_chat_history(container, chat_history, processing=False):
    ...
    chat_history_html = (
        ...
        <div style="height: 400px; overflow-y: auto; padding: 5px; border: 1px solid #ccc;">
            ...
            <div style="background-color: #C9D0DA; padding: 10px; border-radius: 5px; display: flex; align-items: center; margin-bottom: 10px;">
                <img src="https://raw.githubusercontent.com/pedropaixaomprj/Projeto-Corujita/e266fab5c04a112b363a09c8da96f35d1270b06e/imgs/corujita_transparente.png" style="width: 50px; margin-right: 10px; background-color: transparent !important; background-blend-mode: multiply;">
                <div>
                    <div style="text-align: left; font-size: 1.2rem; font-weight: bold;">Corujita</div>
                    <div style="text-align: left; font-size: 1rem;">Assistente virtual</div>
                </div>
            </div>
        '''
    )
    ...
    for mensagem in chat_history:
        if mensagem["role"] == "assistant":
            chat_history_html += f'''
                <div style="text-align: left; background-color: #E6E8F0;
                             color: #000000; border-radius: 10px; padding: 8px; 
            ...
            chat_history_html += f'''
                <div style="text-align: right; background-color: #B9DDC3;
                             color: #000000; border-radius: 10px; padding: 8px;
